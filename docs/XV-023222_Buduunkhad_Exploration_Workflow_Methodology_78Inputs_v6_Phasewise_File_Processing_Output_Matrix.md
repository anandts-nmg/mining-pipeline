<!-- source: XV-023222_Buduunkhad_Exploration_Workflow_Methodology_78Inputs_v6_Phasewise_File_Processing_Output_Matrix.docx (converted from Word; canonical form for LLM ingestion) -->
...
CMCS/MRPAM nearest deposit/occurrence check-ийг L23222 boundary-гаас 5 km, 10 km, 20 km buffer-аар хийж register үүсгэнэ.
...
| QA/QC item | QGIS дээр шалгах арга | QGIS дээр шалгах арга | Pass criteria | Pass criteria | Fail / action |
| --- | --- | --- | --- | --- | --- |
| CRS | Layer Properties -> Source | Layer Properties -> Source | EPSG:32647 | EPSG:32647 | Wrong CRS бол reproject/georef дахин |
| Extent | Layer Properties -> Information + map canvas | Layer Properties -> Information + map canvas | License/buffer/map sheet-тэй logical overlap | License/buffer/map sheet-тэй logical overlap | Outside extent бол GCP/check coordinate |
| GCP count | Georeferencer GCP table | Georeferencer GCP table | Scale-specific minimum хангагдсан | Scale-specific minimum хангагдсан | GCP нэмэх |
| Residual/RMSE | GCP residual table | GCP residual table | Outlier багатай, grid alignment зөв | Outlier багатай, grid alignment зөв | Outlier GCP-г шалгах/хасах |
| Grid alignment | Coordinate grid/tick давхцал | Coordinate grid/tick давхцал | Булан болон дунд grid сайн таарсан | Булан болон дунд grid сайн таарсан | Transformation/GCP дахин |
| Visual distortion | Raster rotation/stretch | Raster rotation/stretch | Уншигдахуйц, суналт хэтрээгүй | Уншигдахуйц, суналт хэтрээгүй | TPS/scan crop дахин |
| Raster completeness | Canvas display / overview | Canvas display / overview | Зураг тасалдаагүй, эргээгүй | Зураг тасалдаагүй, эргээгүй | Export/render setting шалгах |
| Metadata | Inventory + properties | Inventory + properties | Source file, scale, year, map sheet бүртгэгдсэн | Source file, scale, year, map sheet бүртгэгдсэн | Metadata register бөглөх |
| Raster confidence | Raster confidence | Шалгуур | Шалгуур | Use status | Use status |
| High | High | 8+ well-distributed GCP; grid/coordinate сайн; residual acceptable; license/topographic overlay сайн; scan quality good | 8+ well-distributed GCP; grid/coordinate сайн; residual acceptable; license/topographic overlay сайн; scan quality good | Target-scale digitizing болон Phase 4 ranking-д ашиглаж болно | Target-scale digitizing болон Phase 4 ranking-д ашиглаж болно |
| Medium | Medium | 4-8 GCP; minor distortion; overlay logical; зарим grid/scan issue байна | 4-8 GCP; minor distortion; overlay logical; зарим grid/scan issue байна | Overlay/interpretation-д болгоомжтой ашиглана | Overlay/interpretation-д болгоомжтой ашиглана |
| Low | Low | GCP цөөн; grid тодорхойгүй; regional scale; visual match давамгайлсан | GCP цөөн; grid тодорхойгүй; regional scale; visual match давамгайлсан | Context evidence; local target boundary болгохгүй | Context evidence; local target boundary болгохгүй |
| Needs verification | Needs verification | CRS/georef эргэлзээтэй; residual өндөр; feature location conflict | CRS/georef эргэлзээтэй; residual өндөр; feature location conflict | Vector digitizing хийхээс өмнө дахин шалгана | Vector digitizing хийхээс өмнө дахин шалгана |
...
| Criterion | Score 0 | Score 0 | Score 1 | Score 2 | Score 2 | Weight |
| --- | --- | --- | --- | --- | --- | --- |
| Source quality | Unknown source | Unknown source | Known file but partial metadata | Known source + year + scale + map sheet | Known source + year + scale + map sheet | 10% |
| Scan quality | Unreadable/poor | Unreadable/poor | Usable with unclear areas | Clear symbols/labels | Clear symbols/labels | 10% |
| Legend clarity | Missing | Missing | Partial/unclear | Clear linked legend | Clear linked legend | 10% |
| GCP quality | Insufficient/weak | Insufficient/weak | Minimum met | Well-distributed preferred count | Well-distributed preferred count | 15% |
| Georeference accuracy | High residual/conflict | High residual/conflict | Acceptable regional | Good overlay/grid | Good overlay/grid | 15% |
| Map scale suitability | Too regional | Too regional | Regional/context | Target-scale/local | Target-scale/local | 10% |
| Digitizing clarity | Approximate | Approximate | Mostly clear | Clear symbol/boundary | Clear symbol/boundary | 10% |
| Attribute completeness | Many NULL/unknown | Many NULL/unknown | Minor gaps | Complete required fields | Complete required fields | 10% |
| Cross-map consistency | Conflict | Conflict | Not checked/neutral | Supports other evidence | Supports other evidence | 5% |
| Validation status | Historical only | Historical only | Field checked/sample pending | Sampled/lab confirmed | Sampled/lab confirmed | 5% |
| Total score | Total score | Confidence class | Confidence class | Confidence class | Use status | Use status |
| >=80 | >=80 | High | High | High | Target ranking-д ашиглаж болно; field validation шаардлагатай хэвээр | Target ranking-д ашиглаж болно; field validation шаардлагатай хэвээр |
| 60-79 | 60-79 | Medium | Medium | Medium | Overlay/interpretation-д болгоомжтой ашиглана | Overlay/interpretation-д болгоомжтой ашиглана |
| 40-59 | 40-59 | Low | Low | Low | Context evidence; decision-grade ашиглахгүй | Context evidence; decision-grade ашиглахгүй |
| <40 or critical fail | <40 or critical fail | Needs verification | Needs verification | Needs verification | Ашиглахаас өмнө дахин шалгах, field/lab/report validation шаардлагатай | Ашиглахаас өмнө дахин шалгах, field/lab/report validation шаардлагатай |
...
| Data gap register column | Data gap register column | Description | Description |
| gap_id | gap_id | Unique ID, e.g. BUD-GAP-001 | Unique ID, e.g. BUD-GAP-001 |
| source_map_id | source_map_id | Related BK-SCAN ID | Related BK-SCAN ID |
| feature_id | feature_id | Related feature if spatial | Related feature if spatial |
| gap_type | gap_type | Controlled gap type | Controlled gap type |
| gap_description | gap_description | Detailed issue | Detailed issue |
| impact_on_use | impact_on_use | How it affects use | How it affects use |
| confidence_impact | confidence_impact | Decrease / hold / exclude | Decrease / hold / exclude |
| required_action | required_action | What to do | What to do |
| responsible_person | responsible_person | Owner | Owner |
| due_date | due_date | Target date | Target date |
| status | status | Open / In progress / Closed / Deferred | Open / In progress / Closed / Deferred |
| closure_note | closure_note | How it was resolved | How it was resolved |
...
| Cross-map consistency field | Cross-map consistency field | Description | Description |
| evidence_id | evidence_id | Feature/evidence ID | Feature/evidence ID |
| related_map_1 | related_map_1 | First map ID | First map ID |
| related_map_2 | related_map_2 | Second map ID | Second map ID |
| match_type | match_type | Overlap / Near / Conflict / Supports / No relation | Overlap / Near / Conflict / Supports / No relation |
| spatial_relationship | spatial_relationship | Within / intersects / adjacent / upstream / downstream | Within / intersects / adjacent / upstream / downstream |
| geological_relationship | geological_relationship | Contact / same unit / structure controlled / no relation | Contact / same unit / structure controlled / no relation |
| confidence_impact | confidence_impact | Increase / Neutral / Decrease / Needs verification | Increase / Neutral / Decrease / Needs verification |
| required_action | required_action | Field check / review legend / re-georef / report check | Field check / review legend / re-georef / report check |

# 21. Handover package ба acceptance criteria

| Deliverable | File / folder | File / folder | Use | Use | Acceptance criteria |
| --- | --- | --- | --- | --- | --- |
| Master QGIS Project | XV023222_Buduunkhad_HistoricalScannedMaps_Vectorization_QGIS_EPSG32647_v02.qgz | XV023222_Buduunkhad_HistoricalScannedMaps_Vectorization_QGIS_EPSG32647_v02.qgz | Layer overlay, review, map production, QField package preparation | Layer overlay, review, map production, QField package preparation | Opens without missing layers; relative paths OK |
| Master GeoPackage | XV023222_Buduunkhad_HistoricalScannedMaps_Vectorized_MasterGIS_EPSG32647_v02.gpkg | XV023222_Buduunkhad_HistoricalScannedMaps_Vectorized_MasterGIS_EPSG32647_v02.gpkg | All vector evidence layers in EPSG:32647 | All vector evidence layers in EPSG:32647 | All mandatory layers created or documented as N/A |
| Georeferenced GeoTIFF folder | 04_Georeference_Check/02_Georeferenced_Rasters | 04_Georeference_Check/02_Georeferenced_Rasters | Base raster for audit and future redigitizing | Base raster for audit and future redigitizing | Priority map GeoTIFF complete + QAQC |
| Excel QA/QC workbook | XV023222_Buduunkhad_HistoricalScannedMaps_Vectorization_Register_QAQC_v02.xlsx | XV023222_Buduunkhad_HistoricalScannedMaps_Vectorization_Register_QAQC_v02.xlsx | Register, QA/QC, confidence, data gap, change log | Register, QA/QC, confidence, data gap, change log | Required sheets complete; no missing required fields |
| PDF index maps | Phase1_Master_GIS_Index_Maps.pdf | Phase1_Master_GIS_Index_Maps.pdf | Review / reporting | Review / reporting | License + evidence layers shown |
| README + Change log | README.txt, Change_Log.xlsx | README.txt, Change_Log.xlsx | Audit trail and handover note | Audit trail and handover note | Version, CRS, source note, limitations documented |
| Handover phase | Handover phase | Required layers | Required layers | Decision use | Decision use |
| Phase 3 Geological / Metallogenic Synthesis | Phase 3 Geological / Metallogenic Synthesis | Geology, structures, metallogenic zones, occurrence context | Geology, structures, metallogenic zones, occurrence context | Concept model, deposit style, regional context | Concept model, deposit style, regional context |
| Phase 4 Preliminary Prospect Ranking | Phase 4 Preliminary Prospect Ranking | Occurrence, target zones, geology, geochem anomalies, confidence layers | Occurrence, target zones, geology, geochem anomalies, confidence layers | Evidence scoring, A/B/C/D ranking | Evidence scoring, A/B/C/D ranking |
| Phase 6 Recon Mapping and pXRF | Phase 6 Recon Mapping and pXRF | QField-ready observation/source materials/target points | QField-ready observation/source materials/target points | Field validation and pXRF route planning | Field validation and pXRF route planning |
| Phase 7 Rock Chip Sampling | Phase 7 Rock Chip Sampling | Mineral occurrences, structures, target zones, source observations | Mineral occurrences, structures, target zones, source observations | Rock chip candidate locations | Rock chip candidate locations |
| Phase 8/9 Soil / Stream Sediment Planning | Phase 8/9 Soil / Stream Sediment Planning | Drainage, heavy mineral, stream sediment anomaly, geology/structure | Drainage, heavy mineral, stream sediment anomaly, geology/structure | Orientation survey and systematic grid planning | Orientation survey and systematic grid planning |
| QField field validation package | QField field validation package | Approved subset of points/targets/routes + forms | Approved subset of points/targets/routes + forms | Mobile field verification | Mobile field verification |
