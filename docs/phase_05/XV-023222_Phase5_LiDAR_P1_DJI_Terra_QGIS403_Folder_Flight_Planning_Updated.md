<!-- source: XV-023222_Phase5_LiDAR_P1_DJI_Terra_QGIS403_Folder_Flight_Planning_Updated.docx (converted from Word; canonical form for LLM ingestion) -->

# XV-023222 Phase 5 — LiDAR–P1 талбайн нислэгийн төлөвлөлт, DJI Terra ба QGIS 4.0.3 боловсруулалтын ажлын фолдер ба алхамчилсан заавар
...
│   ├── 04_Flight_Mission_Plan.xlsx
│   ├── 05_PreFlight_Checklist.xlsx
│   └── 06_GCP_Checkpoint_Planning_Sheet.xlsx
│
├── 01_Input_Data/
│   ├── 01_License_Boundary/
...
## 5. Алхам 2 — Талбайн нислэгийн төлөвлөлт хийх
Энэ алхам нь L3/L2 LiDAR болон P1 камерын нислэгийг талбай дээр гарахаас өмнө нэг CRS, нэг block/prospect ID, нэг QA/QC логиктойгоор төлөвлөх зорилготой. Нислэгийн төлөвлөлтийг баталгаажуулсны дараа л raw data backup, DJI Terra processing, QGIS тайлал руу шилжинэ.
### 5.1 Planning-ийн үндсэн зорилго ба гаралт
Төлөвлөлтийн үндсэн зорилго нь license boundary доторх зорилтот талбайг бүрэн хамруулах, LiDAR-аар байрлал-өндрийн суурь гаргах, P1-ээр литологи/outcrop/detail зураг авах, GCP/checkpoint-ийг зөв байрлуулах, нислэгийн эрсдэлийг талбай дээр гарахаас өмнө бууруулах юм.
Гарах үндсэн материал:
01) XV023222_Drone_Survey_Block_Plan_UTM47N.gpkg
02) XV023222_Flight_Mission_Plan.xlsx
03) XV023222_GCP_Checkpoint_Plan_UTM47N.gpkg
04) XV023222_PreFlight_Checklist.xlsx
05) XV023222_Field_Risk_Safety_Log.docx
06) DJI Pilot / DJI Pilot 2 / DJI Terra mission files, if exported
### 5.2 Pre-flight input package бүрдүүлэх
QGIS 4.0.3 дээр flight planning map бэлтгэхдээ дараах layer-уудыг нэг project-д давхарлаж харуулна: license boundary, Phase 4 target/prospect polygon, CMCS/MRPAM geology and mineral occurrence, DEM/DTM, slope, hillshade, drainage, access road, camp/refuel point, powerline/settlement/no-fly restriction, GCP/checkpoint candidate points, previous imagery/basemap.
CMCS/MRPAM geological map болон mineral occurrence layer-ийг ашиглахдаа ойролцоох илрэл, хүдэржилтийн төрөл, геологийн контакт, хагарал/lineament, intrusive/contact zone, alteration indication зэргийг нислэгийн priority-тэй холбож тэмдэглэнэ.
### 5.3 QGIS дээр survey block ба prospect priority тогтоох
Drone_Survey_Blocks layer дээр L3 reconnaissance block-уудыг BLK001, BLK002 гэх мэтээр зурна. Drone_Prospect_Targets layer дээр P1 detail prospect-уудыг PR01, PR02 гэх мэтээр зурж A/B/C priority өгнө. A priority нь structure intersection + geology/contact + mineral occurrence/alteration/outcrop evidence давхцсан талбай байна.
Block/prospect attribute minimum:
project_id = XV023222
block_id = BLK001 / BLK002
prospect_id = PR01 / PR02
priority = A / B / C
flight_sensor = L3 / L2 / P1
planned_area_ha = ___
planned_gsd_cm = ___
planned_altitude_agl_m = ___
planned_overlap_front = ___
planned_overlap_side = ___
reason = structure + geology + occurrence + access
status = planned / approved / flown / reflight
### 5.4 L3 LiDAR reconnaissance нислэг төлөвлөх
L3 нислэг нь license/prospect context, DTM/DSM, hillshade, drainage, slope break, fault corridor болон P1 processing-ийн байрлал-өндрийн reference гаргах үндсэн нислэг байна. Нислэгийн шугамыг гол structural trend-тэй аль болох хөндлөн эсвэл 30-60 градусын өнцгөөр төлөвлөж, strip overlap-ийг хангалттай авна.
L3 planning default:
Altitude: ойролцоогоор 80-120 м AGL, terrain болон safety-аас хамааруулна
Speed: ойролцоогоор 8-12 m/s
Side overlap / strip overlap: хамгийн багадаа 20-30%
Cross-line: block бүрд 5-10% эсвэл QA/QC шаардлагатай хэсэгт
Point density target: ≥20 pts/m²
Output CRS: EPSG:32647
Coverage: block boundary + 30-50 м buffer
### 5.5 P1 detail photogrammetry нислэг төлөвлөх
P1 нислэг нь P1 orthomosaic, lithology, outcrop, quartz vein, alteration, sample/trench planning detail гаргах зориулалттай. P1 prospect-ийг зөвхөн L3 terrain reference, GCP/checkpoint plan, access/safety plan баталгаажсаны дараа нисгэнэ.
P1 planning default:
Altitude: ойролцоогоор 60 м AGL, 35 мм линзтэй үед ~0.8 см/pixel GSD зорилт
Front overlap: 80% орчим
Side overlap: 70% орчим
Flight speed: ойролцоогоор 5-7 m/s
Camera angle: nadir / 90°
Image mode: JPG + DNG, боломжтой бол
White balance / exposure: fixed буюу manual тохиргоо
Coverage: PR boundary + 20-30 м buffer
Avoid: сүүдэр ихтэй цаг, хурц салхи, тоосжилт, хур тунадас
### 5.6 L2 нэмэлт LiDAR нислэг төлөвлөх нөхцөл
L2-г default байдлаар бүх талбайд төлөвлөхгүй. Ургамалтай, texture султай outcrop, P1 SfM alignment эрсдэлтэй, trench/detail structural mapping-д 0.1 м орчим micro-relief хэрэгтэй, эсвэл L3 point density/detail хангалтгүй болсон prospect дээр нэмэлтээр төлөвлөнө.
### 5.7 GCP/checkpoint төлөвлөлт
GCP/checkpoint нь P1 болон LiDAR-P1 co-registration QA/QC-ийн үндсэн хяналт болно. Prospect бүрд хамгийн багадаа 5 GCP + 2-3 checkpoint төлөвлөж, булан, төв, өндөр/налуу өөрчлөгдөх хэсэг, outcrop/road зэрэг тогтвортой гадаргуу дээр тараана.
GCP/checkpoint default:
P1 prospect spacing: ойролцоогоор 100 м
Marker size: P1 GSD-д тод харагдахуйц, ихэвчлэн 50-80 см
Surface: тогтвортой, хөдөлгөөнгүй, сүүдэр багатай
Survey method: RTK/PPK/static GNSS, base datum нэг байх
CRS: EPSG:32647
Vertical datum: төслийн GNSS/RTK datum-тай ижил
Use: GCP = adjustment, Checkpoint = independent accuracy test
### 5.8 Weather, safety, access checklist
Талбай дээр нислэг эхлэхээс өмнө салхи, хур тунадас, температур, харагдац, нарны өнцөг, сүүдэр, тоосжилт, powerline/settlement, мал/хүн хөдөлгөөн, emergency landing area, access road, battery charging, SD card capacity, GNSS base location, radio/phone communication зэргийг шалгана.
Pre-flight go/no-go check:
Wind: drone болон sensor-ийн safe operating limit дотор
Rain/snow: байхгүй
Visibility: safe visual operation хангалттай
GNSS/RTK: FIX quality боломжтой
Battery: mission + reserve хангалттай
SD/storage: mission бүрд хангалттай сул зайтай
Firmware/calibration: шалгасан
Emergency landing: тэмдэглэсэн
Field team: pilot, observer, surveyor role тодорхой
### 5.9 DJI mission setup хийх дараалал
DJI Pilot / DJI Pilot 2 / DJI Terra mission setup дээр mission name, sensor, altitude AGL, terrain follow, overlap, speed, camera mode, base station, CRS, takeoff/landing, return-to-home height, obstacle/terrain safety setting-ийг Flight_Mission_Plan.xlsx-тэй тулгаж оруулна.
Mission naming:
YYYYMMDD_XV023222_SENSOR_BLOCKorPR_MISSION
Жишээ:
20260610_XV023222_L3_BLK001_M001
20260610_XV023222_P1_PR01_M001
20260610_XV023222_L2_PR01_M001
### 5.10 Талбай дээр нислэг гүйцэтгэх дараалал
Гүйцэтгэлийн дараалал: 1) base station/GNSS setup, 2) GCP/checkpoint marker тавих ба хэмжих, 3) L3 reconnaissance block нисгэх, 4) quick coverage/RTK/file count QA хийх, 5) P1 detail prospect нисгэх, 6) шаардлагатай бол L2 detail нисгэх, 7) mission бүрийн field log бөглөх, 8) raw data-г backup workflow руу шилжүүлэх.
### 5.11 Талбайгаас буцахын өмнөх acceptance check
Нислэг дууссаны дараа талбай дээрээс буцахаас өмнө дараах шалгалтыг заавал хийж accept/reflight шийдвэр гаргана.
Field acceptance criteria:
Coverage: block/prospect 100% + buffer бүрхсэн
Overlap: planned front/side overlap хангагдсан
RTK/PPK: FIX / trajectory log бүрэн
Photos: missing sequence, blur, over/under exposure байхгүй
LiDAR: calibration/trajectory/point cloud quick preview OK
GCP: P1 зураг дээр marker тод харагдсан
File count: SD card = field laptop backup тоо таарсан
Weather log: mission бүрд бөглөсөн
Decision: accept / partial accept / reflight
### 5.12 Flight planning register бөглөх загвар
00_Admin_Register/04_Flight_Mission_Plan.xlsx файлд дараах баганатай хүснэгт үүсгэнэ.
mission_id | date | sensor | block_id | prospect_id | priority | area_ha | altitude_agl_m | speed_ms | front_overlap | side_overlap | planned_gsd_cm | terrain_follow | gcp_count | checkpoint_count | pilot | observer | weather | risk_level | output_folder | status | remarks
## 6. Алхам 3 — Raw data backup хийх
### 6.1 Backup зарчим
...
## 7. Алхам 4 — QGIS 4.0.3 project бэлтгэх
### 7.1 Project үүсгэх
QGIS 4.0.3 нээгээд:
Project → New
...
## 8. Алхам 5 — L3 LiDAR-ийг DJI Terra дээр боловсруулах
...
### 8.2 Raw folder import хийх
Terra дээр:
Files → Select Folder
Дараах фолдерийг сонгоно.
02_Raw_Data_Backup/01_L3_LiDAR_Raw/BLK001/
### 8.3 PPK / RTK тохируулах
...
## 9. Алхам 6 — L3 LiDAR QA/QC хийх
### 9.1 DJI Terra report шалгах
...
### 9.2 QGIS дээр L3 output шалгах
...
## 10. Алхам 7 — L3 DTM-ээс terrain derivative гаргах
### 10.1 QGIS дээр hillshade гаргах
QGIS:
...
## 11. Алхам 8 — L3 дээр prospect / structure ялгах
### 11.1 Ашиглах layer
...
## 12. Алхам 9 — P1 боловсруулахын өмнөх LiDAR reference package бэлтгэх
Энэ бол шинэчилсэн workflow-ийн гол хэсэг.
### 12.1 P1-д ашиглах L3/LiDAR reference багц
...
## 13. Алхам 10 — P1 фотограмметрийн processing хийх
...
RTK/PPK data
GCP/checkpoint CSV
### 13.3 Coordinate system тохируулах
Output CRS = EPSG:32647
Vertical datum = төслийн GNSS/RTK datum-тай ижил
### 13.4 GCP/checkpoint оруулах
...
## 14. Алхам 11 — P1 output-ийг LiDAR reference-тай шалгах
### 14.1 QGIS дээр давхарлах
QGIS-д дараах layer-уудыг оруулна.
...
### 14.4 Co-registration QA хүснэгт
...
## 15. Алхам 12 — Хэрэв L2 ашигласан бол боловсруулах
...
## 16. Алхам 13 — QGIS 4.0.3 дээр тайлал хийх
### 16.1 Layer stack дараалал
...
L3/L2 DTM
Basemap / geology
### 16.2 P1 orthomosaic дээр outcrop digitize хийх
...
### 16.3 Contact / vein / lineament digitize хийх
...
### 17.4 Layout дээр бичих мэдээлэл
Зураг бүр дээр:
Project name
Prospect ID
Crop ID
...
Legend
## 18. Алхам 15 — Field planning layer гаргах
### 18.1 Sample point planning
...
### 19.3 LiDAR–P1 co-registration QA/QC
...
## 20. Алхам 17 — Final deliverables бэлтгэх
...
└── 07_Archive_Package/
    ...
    ├── QAQC_Checklist.xlsx
    ├── Flight_Mission_Plan.xlsx
    ├── PreFlight_Checklist.xlsx
    └── Version_Control_Log.docx
## 21. Алхам бүрийн action log бөглөх загвар
...
## 22. Нэг prospect дээр хийх богино дараалал
